...
export default function RecipeForm(props) {
  ...
  return (<div>
    <form onSubmit={props.handleSubmit}>
        ...
        <div className="form-group row">
          <label htmlFor="description" className="col-sm-2 col-form-label">Omschrijving:</label>
            <div className="col-sm-10">
        ...
        <div className="form-group row">
          <label htmlFor="body" className="col-sm-2 col-form-label">Toppings:</label>
            <div className="col-sm-10">
              {Object.keys(props.toppingCheckboxes).map(toppingId => {
                return (
                  <div>
                    <label htmlFor={toppingId}>{props.toppings.find(topp => topp.id == toppingId).name}</label>
