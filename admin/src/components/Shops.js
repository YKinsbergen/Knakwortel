    ...
    <div>
      <div class="pt-3 pb-2 mb-3">
        ...
        <input type="file" name="shopsCsv" id="shopsCsv" onChange={props.addShopsOnChange}/>
          ...
          <p className="instructiesShopUploadTitle">
            <small>
              <b><a data-toggle="collapse" href="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">Optie 1: Creëer een CSV bestand</a></b>
            </small></p>
          ...
          <p className="instructiesShopUploadTitle">
            <small>
              <b><a data-toggle="collapse" href="#collapseExample2" aria-expanded="false" aria-controls="collapseExample2">Optie 2 (back up optie): Via het aangeleverde voorbeeldfile</a></b>
            </small></p>
